...
const Medication_equipment = new Schema({
  ...
  const ParaPharmaceutical_equipmen = new Schema({
     category: {
      type: String,
...
const ParaPharmaceutical = MedicalEquipment.discriminator('ParaPharmaceutical_equipment', ParaPharmaceutical_equipmen);
